...
int main(int argc, char **argv) {
   ...
   vfd->header->function_samplecount = 5;
   ...
   vfd->stack_samples[3].stackID = 4;
   vfd->stack_samples[3].sampletime = 6000000ll;

   vfd->stack_samples[4].kind = fnct_exit;
   vfd->stack_samples[4].stackID = 0;
   vfd->stack_samples[4].sampletime = 11000000ll;
   ...
   check_fcall(vfd->fcalls[1], 1, 1.0,  8.5);
   check_fcall(vfd->fcalls[2], 2, 2.0,  4.0);
   check_fcall(vfd->fcalls[3], 4, 6.0,  8.5);
}
