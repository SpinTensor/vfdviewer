...
int main(int argc, char **argv) {
   ...
   vfd->stack_samples[0].sampletime = 3000000ll;
   ...
   check_fcall(vfd->fcalls[0], 1, 0.0,  9.5);
   check_fcall(vfd->fcalls[1], 2, 0.0,  5.5);
   check_fcall(vfd->fcalls[2], 0, 0.0, 11.0);
   check_fcall(vfd->fcalls[3], 3, 3.0,  5.5);
   check_fcall(vfd->fcalls[4], 5, 5.5,  8.0);
   check_fcall(vfd->fcalls[5], 4, 5.5,  9.5);
