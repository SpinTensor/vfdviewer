...
int main(int argc, char **argv) {
   ...
   vfd->header->function_samplecount = 12;
   ...
   vfd->stack_samples[1].kind = fnct_entry;
   vfd->stack_samples[1].stackID = 1;
   vfd->stack_samples[1].sampletime = 1000000ll;

   vfd->stack_samples[2].kind = fnct_entry;
   vfd->stack_samples[2].stackID = 2;
   vfd->stack_samples[2].sampletime = 2000000ll;

   vfd->stack_samples[3].kind = fnct_entry;
   vfd->stack_samples[3].stackID = 3;
   vfd->stack_samples[3].sampletime = 3000000ll;

   vfd->stack_samples[4].kind = fnct_exit;
   vfd->stack_samples[4].stackID = 3;
   vfd->stack_samples[4].sampletime = 4000000ll;

   vfd->stack_samples[5].kind = fnct_exit;
   vfd->stack_samples[5].stackID = 2;
   vfd->stack_samples[5].sampletime = 5000000ll;

   vfd->stack_samples[6].kind = fnct_entry;
   vfd->stack_samples[6].stackID = 4;
   vfd->stack_samples[6].sampletime = 6000000ll;

   vfd->stack_samples[7].kind = fnct_entry;
   vfd->stack_samples[7].stackID = 5;
   vfd->stack_samples[7].sampletime = 7000000ll;

   vfd->stack_samples[8].kind = fnct_exit;
   vfd->stack_samples[8].stackID = 5;
   vfd->stack_samples[8].sampletime = 8000000ll;

   vfd->stack_samples[9].kind = fnct_exit;
   vfd->stack_samples[9].stackID = 4;
   vfd->stack_samples[9].sampletime = 9000000ll;

   vfd->stack_samples[10].kind = fnct_exit;
   vfd->stack_samples[10].stackID = 1;
   vfd->stack_samples[10].sampletime = 10000000ll;

   vfd->stack_samples[11].kind = fnct_exit;
   vfd->stack_samples[11].stackID = 0;
   vfd->stack_samples[11].sampletime = 11000000ll;
   ...
   check_fcall(vfd->fcalls[0], 0, 0.0, 11.0);
   check_fcall(vfd->fcalls[1], 1, 1.0, 10.0);
   check_fcall(vfd->fcalls[2], 2, 2.0,  5.0);
   check_fcall(vfd->fcalls[3], 3, 3.0,  4.0);
   check_fcall(vfd->fcalls[4], 4, 6.0,  9.0);
   check_fcall(vfd->fcalls[5], 5, 7.0,  8.0);
}
