...
int main(int argc, char **argv) {
   ...
   vfd->stack_samples[1].sampletime = 8000000ll;
   ...
   check_fcall(vfd->fcalls[1], 2, 0.0,  6.0);
   check_fcall(vfd->fcalls[2], 1, 0.0,  9.5);
   check_fcall(vfd->fcalls[3], 0, 0.0, 11.0);
   check_fcall(vfd->fcalls[4], 5, 6.0,  8.0);
   check_fcall(vfd->fcalls[5], 4, 6.0,  9.5);
}
